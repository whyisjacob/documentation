...
To use Cloud Cost Management, you must have an AWS account with access to Cost and Usage Reports (CURs), and have the AWS integration installed in Datadog. To set up Cloud Cost Management in Datadog, you need to generate a legacy Cost and Usage report.

## Setup

### Prerequisite: generate a Legacy Cost and Usage Report
...
### Locate the Legacy Cost and Usage Report
...
### Configure access to the Legacy Cost and Usage Report
